...
const ListScreen = () => {
    ...
    //To create a list in react native
    return (
    <FlatList
    //This will align items horizontally.
    //    horizontal,showsHorizontalScrollIndicator is a prop of Flatlist
    //This will hide the horizontal scroll bar.
    //KeyExtractor is necessary to have while using FlatList
